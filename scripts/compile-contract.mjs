...
const entryUnit = 'contracts/AiStocksIndexRouterV1.sol';
...
const artifact = output.contracts[entryUnit].AiStocksIndexRouterV1;
...
const generated = `// AUTO-GENERATED by scripts/compile-contract.mjs. Do not edit.\nexport const indexRouterAbi = ${JSON.stringify(artifact.abi, null, 2)} as const;\nexport const indexRouterBytecode = ${JSON.stringify(bytecode)} as const;\nexport const compilerVersion = ${JSON.stringify(rawCompilerVersion)} as const;\n`;

const verificationGenerated = `// AUTO-GENERATED by scripts/compile-contract.mjs. Server-side only. Do not edit.\nexport const indexRouterStandardJsonInput = ${JSON.stringify(standardJsonInput)} as const;\nexport const etherscanCompilerVersion = ${JSON.stringify(etherscanCompilerVersion)} as const;\nexport const etherscanContractName = ${JSON.stringify(`${entryUnit}:AiStocksIndexRouterV1`)} as const;\n`;

fs.writeFileSync(path.join(root, 'lib', 'index-router.generated.ts'), generated);
fs.writeFileSync(
  path.join(root, 'lib', 'index-router.verification.generated.ts'),
  verificationGenerated,
);

console.log(`Compiled AiStocksIndexRouterV1 with ${rawCompilerVersion}`);
