...
const unit = "contracts/ScanArcCCTPBridgeV1.sol";
const name = "ScanArcCCTPBridgeV1";
...
const generated = `// AUTO-GENERATED FROM ${unit}. Do not edit.\nexport const cctpBridgeAbi = ${JSON.stringify(artifact.abi, null, 2)} as const;\nexport const cctpBridgeBytecode = ${JSON.stringify(`0x${artifact.evm.bytecode.object}`)} as \`0x\${string}\`;\nexport const cctpBridgeCompilerVersion = ${JSON.stringify(solc.version())} as const;\n`;
fs.writeFileSync(path.join(root, "lib", "scanarc-cctp-bridge.generated.ts"), generated);
